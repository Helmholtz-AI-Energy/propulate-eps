...
###SBATCH --job-name=propulate-step
###SBATCH --output="/hkfs/work/workspace/scratch/qv2382-propulate/exps/function_benchmark/logs/paper/step/propulate-%j.out"
...
srun "${SRUN_PARAMS[@]}" singularity exec \
  ...
  --bind /hkfs/work/workspace/scratch/qv2382-propulate/bigearthnet_kit/mysql/step/var/lib/mysql/:/var/lib/mysql \
  --bind /hkfs/work/workspace/scratch/qv2382-propulate/bigearthnet_kit/mysql/step/run/mysqld:/run/mysqld \
  --bind /hkfs/work/workspace/scratch/qv2382-propulate/bigearthnet_kit/mysql/step/var/log/mysql/:/var/log/mysql \
