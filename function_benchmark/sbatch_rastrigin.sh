...
srun "${SRUN_PARAMS[@]}" singularity exec --nv \
  ...
  --bind /hkfs/work/workspace/scratch/qv2382-propulate/bigearthnet_kit/mysql/rastrigin/var/lib/mysql/:/var/lib/mysql \
  --bind /hkfs/work/workspace/scratch/qv2382-propulate/bigearthnet_kit/mysql/rastrigin/run/mysqld:/run/mysqld \
  --bind /hkfs/work/workspace/scratch/qv2382-propulate/bigearthnet_kit/mysql/rastrigin/var/log/mysql/:/var/log/mysql \
