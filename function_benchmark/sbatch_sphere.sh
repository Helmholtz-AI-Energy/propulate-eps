...
#SBATCH --output="/hkfs/work/workspace/scratch/qv2382-propulate/exps/function_benchmark/logs/paper/sphere/optuna-%j.out"
##SBATCH --job-name=propulate-sphere
##SBATCH --output="/hkfs/work/workspace/scratch/qv2382-propulate/exps/function_benchmark/logs/paper/sphere/propulate-%j.out"
...
srun "${SRUN_PARAMS[@]}" singularity exec \
  ...
  --bind /hkfs/work/workspace/scratch/qv2382-propulate/bigearthnet_kit/mysql/sphere/var/lib/mysql/:/var/lib/mysql \
  --bind /hkfs/work/workspace/scratch/qv2382-propulate/bigearthnet_kit/mysql/sphere/run/mysqld:/run/mysqld \
  --bind /hkfs/work/workspace/scratch/qv2382-propulate/bigearthnet_kit/mysql/sphere/var/log/mysql/:/var/log/mysql \
