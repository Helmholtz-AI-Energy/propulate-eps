...
srun "${SRUN_PARAMS[@]}" singularity exec --nv \
  ...
  --bind /hkfs/work/workspace/scratch/qv2382-propulate/bigearthnet_kit/mysql/schwefel/var/lib/mysql/:/var/lib/mysql \
  --bind /hkfs/work/workspace/scratch/qv2382-propulate/bigearthnet_kit/mysql/schwefel/run/mysqld:/run/mysqld \
  --bind /hkfs/work/workspace/scratch/qv2382-propulate/bigearthnet_kit/mysql/schwefel/var/log/mysql/:/var/log/mysql \
