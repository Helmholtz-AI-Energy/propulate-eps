...
#SBATCH --output="/hkfs/work/workspace/scratch/qv2382-propulate/exps/function_benchmark/logs/schwefel/optuna-%j.out"
## #SBATCH --job-name=propulate-schwefel
## #SBATCH --output="/hkfs/work/workspace/scratch/qv2382-propulate/exps/function_benchmark/logs/schwefel/propulate-%j.out"
