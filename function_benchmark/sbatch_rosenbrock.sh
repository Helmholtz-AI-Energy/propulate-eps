...
#SBATCH --output="/hkfs/work/workspace/scratch/qv2382-propulate/exps/function_benchmark/logs/rosenbrock/optuna-%j.out"
## #SBATCH --job-name=propulate-rosenbrock
## #SBATCH --output="/hkfs/work/workspace/scratch/qv2382-propulate/exps/function_benchmark/logs/rosenbrock/propulate-%j.out"
